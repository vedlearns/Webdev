function Footer(){
  return(
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 bg-gray-800 lg:px-8">
            {/* <!--Grid--> */}
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                ...
                <div className="lg:mx-auto text-left ">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-white hover:text-blue-600">Home</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">About</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">Pricing</a></li>
                        <li><a href="javascript:;"  className=" text-white hover:text-blue-600">Features</a></li>
                    </ul>
                </div>
                {/* <!--End Col--> */}
                <div className="lg:mx-auto text-left ">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-white hover:text-blue-600">Figma UI System</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">Icons Assets</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">Responsive Blocks</a></li>
                        <li><a href="javascript:;"  className=" text-white hover:text-blue-600">Components Library</a></li>
                    </ul>
                </div>
                {/* <!--End Col--> */}
                <div className="lg:mx-auto text-left">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-white hover:text-blue-600">FAQs</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">Quick Start</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">Documentation</a></li>
                        <li><a href="javascript:;"  className=" text-white hover:text-blue-600">User Guide</a></li>
                    </ul>
                </div>
                {/* <!--End Col--> */}
                <div className="lg:mx-auto text-left">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-white hover:text-blue-600">News</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">Tips & Tricks</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-white hover:text-blue-600">New Updates</a></li>
                        <li><a href="javascript:;"  className=" text-white hover:text-blue-600">Events</a></li>
                    </ul>
                </div>
            </div>
            {/* <!--Grid--> */}
